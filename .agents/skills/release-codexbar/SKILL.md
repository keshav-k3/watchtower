...
PY
codesign --verify --deep --strict --verbose=2 Watchtower.app
spctl --assess --type execute --verbose Watchtower.app
```
...
```bash
pkill -x CodexBar || pkill -f Watchtower.app || true
cd "$(git rev-parse --show-toplevel)"
open -n Watchtower.app
/usr/libexec/PlistBuddy -c 'Print :CFBundleShortVersionString' Watchtower.app/Contents/Info.plist
/usr/libexec/PlistBuddy -c 'Print :CFBundleVersion' Watchtower.app/Contents/Info.plist
```
