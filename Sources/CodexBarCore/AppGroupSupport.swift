...
public enum AppGroupSupport {
    public static let defaultTeamID = "KESHAVK3"
    public static let teamIDInfoKey = "WatchtowerTeamID"
    public static let legacyReleaseGroupID = "group.com.steipete.watchtower"
    public static let legacyDebugGroupID = "group.com.steipete.watchtower.debug"
    ...
    static func currentGroupID(teamID: String, bundleID: String?) -> String {
        let base = "\(teamID).com.keshavk3.watchtower"
        ...
        -> URL
    {
        ...
        let directory = base.appendingPathComponent("Watchtower", isDirectory: true)
