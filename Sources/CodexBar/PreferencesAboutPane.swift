...
struct AboutPane: View {
    ...
    private var buildTimestamp: String? {
        guard let raw = Bundle.main.object(forInfoDictionaryKey: "WatchtowerBuildTimestamp") as? String
        else { return nil }
        ...
        VStack(spacing: 12) {
            ...
            VStack(alignment: .center, spacing: 10) {
                AboutLinkRow(
                    ...
                    title: L("link_github"),
                    url: "https://github.com/keshav-k3/watchtower")
            }
            .padding(.top, 8)
    ...
    private func openProjectHome() {
        guard let url = URL(string: "https://github.com/keshav-k3/watchtower") else { return }
