...
func showAbout() {
    ...
    let buildTimestamp = Bundle.main.object(forInfoDictionaryKey: "WatchtowerBuildTimestamp") as? String
    let gitCommit = Bundle.main.object(forInfoDictionaryKey: "WatchtowerGitCommit") as? String
    ...
    let credits = NSMutableAttributedString(string: "Based on CodexBar by Peter Steinberger - MIT License\n")
    credits.append(makeLink("GitHub", urlString: "https://github.com/keshav-k3/watchtower"))
