...
enum KeychainMigration {
    ...
    static let itemsToMigrate: [MigrationItem] = [
        MigrationItem(service: "com.keshavk3.watchtower", account: "codex-cookie"),
        MigrationItem(service: "com.keshavk3.watchtower", account: "claude-cookie"),
        MigrationItem(service: "com.keshavk3.watchtower", account: "cursor-cookie"),
    ]
