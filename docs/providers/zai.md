...
Watchtower is a GUI app. A one-off `export ...` in a terminal session will not be visible when you launch Watchtower from
Spotlight/Launchpad. Persist it, then restart Watchtower.
...
3. Enable the Z.ai plugin in Watchtower settings
